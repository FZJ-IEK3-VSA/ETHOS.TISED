...
hourly_irrad_m = np.genfromtxt(r'C:\Users\o.omoyele\Desktop\Australia\ND_Model_Mean_QC\Validation_new_new\BSRN\TOR\hourly_irrad_m_modified_2020.csv',delimiter=',')
