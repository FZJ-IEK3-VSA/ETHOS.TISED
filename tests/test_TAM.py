...
def test_solar_models():
    ...
    hourly_irrad_data_path = root_dir.joinpath("Examples", "hourly_data", "TAM.csv")
    ...
    synthetic_data_frame = SolarModel(
        Lat=22.7903, Lon=5.5292, date=2009, data=hourly_irrad_m
    )

    path_to_syntehtic_data = root_dir.joinpath(
        "tests", "test_data", "synthetic_data_TAM.csv"
    )
